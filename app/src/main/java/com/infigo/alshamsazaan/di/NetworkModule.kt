...
import com.infigo.alshamsazaan.BuildConfig
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideAsmaAlHusnaService(@AladhanApi retrofit: Retrofit): AsmaAlHusnaService =
        retrofit.create(
    ...
    @Provides
    @Singleton
    fun provideCalendarApiService(@AladhanApi retrofit: Retrofit): PrayerApiService =
        retrofit.create(
    ...
    @Provides
    @Singleton
    fun provideReadSurahArService(@QuranApi retrofit: Retrofit): ReadSurahArService =
        retrofit.create(
    ...
    @Provides
    @Singleton
    fun provideReadSurahEnService(@QuranApi retrofit: Retrofit): ReadSurahEnService =
        retrofit.create(
