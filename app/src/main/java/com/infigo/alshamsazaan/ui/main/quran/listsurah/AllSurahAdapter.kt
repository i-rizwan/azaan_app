...
import com.infigo.alshamsazaan.databinding.ListAllSurahBinding
...
class AllSurahAdapter : RecyclerView.Adapter<AllSurahAdapter.AllSurahViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AllSurahViewHolder {
        val binding =
            ListAllSurahBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class AllSurahViewHolder(private val binding: ListAllSurahBinding) :
