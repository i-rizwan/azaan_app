...
import com.infigo.alshamsazaan.databinding.ListStaredSurahBinding
...
class StaredSurahAdapter : RecyclerView.Adapter<StaredSurahAdapter.StaredSurahViewHolder>() {
    ...
    private val diffCallback = object : DiffUtil.ItemCallback<MsFavSurah>() {
        ...
        override fun areContentsTheSame(oldItem: MsFavSurah, newItem: MsFavSurah) =
            oldItem == newItem
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StaredSurahViewHolder {
        val binding =
            ListStaredSurahBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return StaredSurahViewHolder(binding)
    }

    override fun getItemCount(): Int = differ.currentList.size

    override fun onBindViewHolder(holder: StaredSurahViewHolder, position: Int) =
        holder.bind(listData[position])

    inner class StaredSurahViewHolder(private val binding: ListStaredSurahBinding) :
